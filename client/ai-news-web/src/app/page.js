    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100 overflow-hidden">
      ...
      <main className="relative max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-20 left-0 w-80 h-80 bg-purple-400/20 rounded-full blur-3xl animate-blob" />
          <div className="absolute top-[500px] right-0 w-[450px] h-[450px] bg-blue-400/20 rounded-full blur-3xl animate-blob animation-delay-2000" />
          <div className="absolute bottom-20 left-1/3 w-[400px] h-[400px] bg-pink-400/10 rounded-full blur-3xl animate-blob animation-delay-4000" />
        </div>
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 mb-10 sm:mb-14">
          ...
          <div className="text-sm text-gray-600 bg-white/80 backdrop-blur-xl px-5 py-3 rounded-2xl shadow-lg border border-white/50">
        ...
        >
          {currentNews.map((item, index) => {
            ...
            return (
              <div
                key={item.link || index}
                className={`transition-all duration-500 ${alignClass}`}
              >
                <NewsCard
                  index={index}
                  title={item.title}
        ...
        <div className="relative z-10 flex items-center justify-center gap-5 mt-20">
          <button
            ...
            className="px-6 py-3 rounded-2xl bg-white/80 backdrop-blur-xl border border-white/50 shadow-lg font-semibold transition-all duration-300 hover:bg-black hover:text-white hover:shadow-2xl hover:-translate-y-1 active:scale-95 disabled:opacity-30"
          >
            ← Prev
          </button>

          <div className="px-6 py-3 bg-black text-white rounded-2xl font-bold shadow-2xl">
            {page} / {totalPages || 1}
          </div>
